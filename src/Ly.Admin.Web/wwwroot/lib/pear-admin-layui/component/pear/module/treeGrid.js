...
layui.config({}).extend({}).define(['laytpl', 'laypage', 'layer', 'form'], function(exports) {
	...
	Class.prototype.treeConvertShowName = function(o) {
		...
		//var temhtml = '<div style="float: left;height: 28px;line-height: 28px;padding-left: ' + 修改为下面的 2021年6月21日
		var temhtml = '<div style="float: left;height: 28px;padding-right:5px;padding-left: ' +
			function() {
				if (isTreeNode) {
					return '5px'
				} else {
