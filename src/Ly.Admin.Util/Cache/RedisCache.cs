...
namespace Ly.Admin.Util.Cache
{
    public class RedisCache:ICache
    {
        ...
        /// <summary>
        /// 默认构造函数
        /// 注：使用默认配置，从配置文件获取,无密码
        /// </summary>
        public RedisCache()
        {
            DatabaseIndex = 0;
            string config = GlobalSettings.LyAdminOptions.CacheType.RedisConfig;
        ...
        public void _SetCache(string key, object value, TimeSpan? timeout, ExpireTypeEnum? expireType)
        {
        ...
        public object GetCache(string key)
        {
            ...
            if (valueInfoEntry.ExpireTime != null && valueInfoEntry.ExpireType == ExpireTypeEnum.Relative)
            {
